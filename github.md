...
- Have a terminal installed of your preference, I recommend Git Bash
- Have a text editor or Integrated Development Environment (IDE) installed
...
<a id="steps"></a>
## Steps on how to use GitHub with git
